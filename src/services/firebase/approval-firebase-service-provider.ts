...
@Injectable()
export class ApprovalFirebaseServiceProvider {
    // https://www.youtube.com/watch?v=-GjF9pSeFTs

    private tableName: string = 'approval';

    constructor(private db: AngularFirestore) { }

    public insertRecord(model: ApprovalModel, callbackMethod) {
    ...
    public updateRecord(model: ApprovalModel, callbackMethod) {
